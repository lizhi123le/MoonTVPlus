...
const USER_AGENTS = [
  ...
  // --- TV & Entertainment (Media App context) ---
  // Android TV
  'Mozilla/5.0 (Linux; Android 11; Sony Bravia 4K Build/RP1A.200720.011) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/123.0.0.0 Safari/537.36',
  // Apple TV
  'Mozilla/5.0 (AppleTV; CPU OS 17_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/17.4 Mobile/15E148 Safari/604.1',
];
